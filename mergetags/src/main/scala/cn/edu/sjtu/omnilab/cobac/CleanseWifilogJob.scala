...
/**
 * Cleanse WIFI movement log;
 * Generate movement sessions with anonymous login.
 *
 * @param args:input the raw wifi syslog collected from server.
 * @param args:output the clean wifi syslog
 */
